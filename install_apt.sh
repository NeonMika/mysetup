...
## termius
sudo wget -cO /tmp/install-termius.deb "https://www.termius.com/download/linux/Termius.deb"
sudo chmod 0755 /tmp/install-termius.deb
sudo apt install /tmp/install-termius.deb
sudo rm /tmp/install-termius.deb
